    ...
    return editor.transact((tr) => {
        ...
        if (tr.selection instanceof CellSelection) {
            return {
                ...
                anchorCellOffset: tr.selection.$anchorCell.pos - anchorBlockPosInfo.posBeforeNode,
                headCellOffset: tr.selection.$headCell.pos - anchorBlockPosInfo.posBeforeNode,
            };
        }
 ...
 */
function updateBlockSelectionFromData(tr, data) {
    ...
    let selection;
    if (data.type === "cell") {
        selection = CellSelection.create(tr.doc, anchorBlockPos + data.anchorCellOffset, anchorBlockPos + data.headCellOffset);
    }
        ...
        selection = TextSelection.create(tr.doc, anchorBlockPos + data.anchorOffset, headBlockPos + data.headOffset);
    }

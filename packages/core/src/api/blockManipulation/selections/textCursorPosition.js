...
import { getBlockInfo, getBlockInfoFromTransaction, } from "../../getBlockInfoFromPos.js";
import { nodeToBlock } from "../../nodeConversions/nodeToBlock.js";
import { getNodeById } from "../../nodeUtil.js";
import { getBlockNoteSchema, getPmSchema } from "../../pmUtil.js";
export function getTextCursorPosition(tr) {
    ...
    return {
        ...
        parentBlock: parentNode === undefined ? undefined : nodeToBlock(parentNode, pmSchema),
    };
}
export function setTextCursorPosition(tr, targetBlock, placement = "start") {
    ...
    if (info.isBlockContainer) {
        ...
        if (contentType === "inline") {
            if (placement === "start") {
                tr.setSelection(TextSelection.create(tr.doc, blockContent.beforePos + 1));
            }
            else {
                tr.setSelection(TextSelection.create(tr.doc, blockContent.afterPos - 1));
            }
        }
            ...
            if (placement === "start") {
                ...
                tr.setSelection(TextSelection.create(tr.doc, blockContent.beforePos + 4));
            }
            else {
                tr.setSelection(TextSelection.create(tr.doc, blockContent.afterPos - 4));
            }
        }
        else {

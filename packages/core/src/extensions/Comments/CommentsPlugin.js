...
export class CommentsPlugin extends BlockNoteExtension {
     ...
     */
    updateMarksFromThreads = (threads) => {
                ...
                node.marks.forEach((mark) => {
                    if (mark.type.name === this.markType) {
                        ...
                        if (isOrphan !== mark.attrs.orphan) {
                            ...
                            const trimmedTo = Math.min(pos + node.nodeSize, tr.doc.content.size - 1, tr.doc.content.size - 1);
    ...
    constructor(editor, threadStore, markType) {
        super();
        this.editor = editor;
        ...
        this.userStore = new UserStore(editor.resolveUsers);
        ...
        this.addProsemirrorPlugin(new Plugin({
            ...
            state: {
                ...
                apply(tr, state) {
                    ...
                    if (self.selectedThreadId) {
                        const selectedThreadPosition = threadPositions.get(self.selectedThreadId);
                        if (selectedThreadPosition) {
                            decorations.push(Decoration.inline(selectedThreadPosition.from, selectedThreadPosition.to, {
            ...
            props: {
                ...
                handleClick: (view, pos, event) => {
                    ...
                    const commentMark = node.marks.find((mark) => mark.type.name === markType && mark.attrs.orphan !== true);
     ...
     */
    selectThread(threadId, scrollToThread = true) {
...
//# sourceMappingURL=CommentsPlugin.js.map
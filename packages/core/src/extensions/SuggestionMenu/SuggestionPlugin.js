 ...
 */
export class SuggestionMenuProseMirrorPlugin extends BlockNoteExtension {
    static key() {
            ...
            state: {
                ...
                apply: (transaction, prev, _oldState, newState) => {
                    ...
                    if (typeof suggestionPluginTransactionMeta === "object" &&
                        ...
                        const trackedPosition = trackPosition(editor, newState.selection.from -

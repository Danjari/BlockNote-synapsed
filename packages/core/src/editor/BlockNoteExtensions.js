...
import { DEFAULT_LINK_PROTOCOL, VALID_LINK_PROTOCOLS, } from "../extensions/LinkToolbar/protocols.js";
...
import { SuggestionAddMark, SuggestionDeleteMark, SuggestionModificationMark, } from "../extensions/Suggestions/SuggestionMarks.js";
...
export const getBlockNoteExtensions = (opts) => {
    ...
    if (opts.comments) {
        ret["comments"] = new CommentsPlugin(opts.editor, opts.comments.threadStore, CommentMark.name);
    }
...
const getTipTapExtensions = (opts) => {
    const tiptapExtensions = [
        ...
        createPasteFromClipboardExtension(opts.editor, opts.pasteHandler ||
            ((context) => context.defaultPasteHandler())),

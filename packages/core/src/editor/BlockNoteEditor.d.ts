...
export declare class BlockNoteEditor<BSchema extends BlockSchema = DefaultBlockSchema, ISchema extends InlineContentSchema = DefaultInlineContentSchema, SSchema extends StyleSchema = DefaultStyleSchema> extends EventEmitter<{
    ...
    getSelectionCutBlocks(): {
        blocks: Block<Record<string, import("../schema/index.js").BlockConfig>, InlineContentSchema, StyleSchema>[];
     ...
     */
    removeBlocks(blocksToRemove: BlockIdentifier[]): Block<Record<string, import("../schema/index.js").BlockConfig>, InlineContentSchema, StyleSchema>[];
    /**
...
//# sourceMappingURL=BlockNoteEditor.d.ts.map
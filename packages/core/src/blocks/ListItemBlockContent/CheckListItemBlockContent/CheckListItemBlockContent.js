...
import { createBlockSpecFromStronglyTypedTiptapNode, createStronglyTypedTiptapNode, propsToAttributes, } from "../../../schema/index.js";
        ...
        return ({ node, getPos, editor, HTMLAttributes }) => {
            ...
            const changeHandler = () => {
                ...
                if (typeof getPos !== "boolean") {
                    ...
                    this.editor.commands.command(updateBlockCommand(beforeBlockContainerPos.posBeforeNode, {
                        type: "checkListItem",
                        props: {

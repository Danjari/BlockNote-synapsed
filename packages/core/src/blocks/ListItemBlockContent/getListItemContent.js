...
name) {
    ...
    if (blockGroupNode.firstChild?.firstChild?.type.name === "checkListItem") {
        ...
        blockGroupNode = blockGroupNode.copy(blockGroupNode.content.cut(blockGroupNode.firstChild.firstChild.nodeSize + 2));
    }
...
//# sourceMappingURL=getListItemContent.js.map
...
import { createDefaultBlockDOMOutputSpec, mergeParagraphs, } from "../defaultBlockHelpers.js";
...
export const QuoteBlockContent = createStronglyTypedTiptapNode({
    ...
    renderHTML({ HTMLAttributes }) {
        return createDefaultBlockDOMOutputSpec(this.name, "blockquote", {
            ...(this.options.domAttributes?.blockContent || {}),
            ...HTMLAttributes,
        }, this.options.domAttributes?.inlineContent || {});
    },
});
export const Quote = createBlockSpecFromStronglyTypedTiptapNode(QuoteBlockContent, quotePropSchema);
//# sourceMappingURL=QuoteBlockContent.js.map